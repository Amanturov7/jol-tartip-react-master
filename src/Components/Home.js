...
const Home = () => {
  ...
  const fetchRecentApplications = async () => {
      try {
          const response = await Axios.get('https://jortartip.onrender.com:8080/rest/applications/latest');
  ...
  const fetchRecentReviews = async () => {
    try {
        const response = await Axios.get('https://jortartip.onrender.com:8080/rest/reviews/latest');
