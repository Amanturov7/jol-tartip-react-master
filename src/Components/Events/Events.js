...
const Events = () => {
  ...
  const fetchEventTypes = async () => {
    try {
      const eventTypeResponse = await Axios.get('https://jortartip.onrender.com/rest/common-reference/by-type/006');
  ...
  const handleCreateEvent = async () => {
    ...
    try {
      const response = await Axios.post('https://jortartip.onrender.com/rest/events/create', {
        ...newEvent,
